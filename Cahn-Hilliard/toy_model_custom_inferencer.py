...
class Li_Graphite_CustomInferencerPlotter(_Plotter):
    """
    ...
    def __call__(self, invar, outvar):
        ...
        plot_configs = [
            ("c_li", "Lithium concentration", "green"),
            ("eta", "Phase variable (eta)", "blue"),
            ("mu", "chemical potential", "pink"),
        ]
